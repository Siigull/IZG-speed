/*!
 * @file
 * @brief This file contains implementation of min blending
 *
...
void vertexShader(OutVertex&outVertex,InVertex const&inVertex,ShaderInterface const&si){
  ...
  Vertex const verts[] = {
    Vertex{glm::vec4(0,0,0,1),glm::vec4(1.0,1.0,1.0,1.)},
    Vertex{glm::vec4(1,0,0,1),glm::vec4(0.0,0.0,0.0,1.)},
    Vertex{glm::vec4(0,1,0,1),glm::vec4(0.0,0.0,0.0,1.)},
  };
